package com.abbink.n26.challenge.common.metrics.response;
...
final class HttpStatusCodeMetricResourceFilter implements ResourceFilter, ContainerResponseFilter {
    ...
    public HttpStatusCodeMetricResourceFilter(MetricRegistry metricRegistry, String metricBaseName, Class<?> resourceClass) {
