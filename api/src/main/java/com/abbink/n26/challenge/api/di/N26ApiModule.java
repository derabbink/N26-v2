package com.abbink.n26.challenge.api.di;

import com.abbink.n26.challenge.api.error.jersey.di.ExceptionMappersModule;
import com.abbink.n26.challenge.api.http.transactionservice.di.TransactionServiceModule;
...
public class N26ApiModule extends AbstractModule {
    ...
    public static String getResourcePackage() {
        return "com.abbink.n26.challenge.api.http";
    }
}
